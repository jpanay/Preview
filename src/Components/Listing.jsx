...
let Listing = ({ listing, selectListing }) => {
  return (
    <div onClick={() => selectListing(listing._id)} className="row align-items-start listing">
      ...
      <div className={listing.occupied.toString().toLowerCase() + " col-1 listing-field occupied"}>{listing.occupied.toString().toLowerCase()}</div>
      <div className={listing.previewed.toString().toLowerCase() + " col-1 listing-field previewed"}>{listing.previewed.toString().toLowerCase()}</div>
      <div className={listing.listed.toString().toLowerCase() + " col-1 listing-field listed"}>{listing.listed.toString().toLowerCase()}</div>
